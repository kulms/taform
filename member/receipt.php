  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="receipt_form.php"> ใบสำคัญรับเงิน (รายเดือน)</a></li>
        <li class="active">ดูรายชื่อนิสิต</li>
      </ol>
    </section>
    <!-- Main content -->
                    ...
                    while($row = $query->fetch_assoc()){
                      echo "
                          <tr>
                            ...
                            <td>
                              <button class='btn btn-warning btn-sm btn-flat' onclick='location.href=\"receipt_generate.php?appsid=".$row['appsid']."&appid=".$row['app_id']."&month=".$_GET['month']."\"' ><i class='fa fa-download'></i> ดาวน์โหลดใบสำคัญรับเงิน</button>                              
                            </td>
                          </tr>
                        ";
                      $i++;
