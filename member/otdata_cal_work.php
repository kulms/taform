  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="otdata_work.php">บัญชีการมาทำงาน</a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
            <div class="box-header with-border">
                <h3 class="box-title">ข้อมูลบัญชีการมาทำงาน</h3>
              </div>              
              ...
              <hr>              
              <table id="example14" class="table table-bordered table-striped table-hover" width="100%">
                <!-- <thead>
                  <th class="hidden"></th>
                  <th width="1%">#</th>
                ...
                <thead>
                  ...
                  <th width="1%">หน่วยงาน</th>
                  <th width="8%">ชื่อ-นามสกุล</th>
                  <th width="4%">วันที่</th>
                  <th width="4%">เวลาเริ่ม</th>
                  <!-- <th width="4%">ขออนุมัติเข้า <br>(เช้า)</th>
                  <th width="4%">สแกนออก <br>(เช้า)</th>
                  <th width="5%">ขออนุมัติออก <br>(เช้า)</th>
                  <th width="4%">สแกนเข้า <br>(บ่าย)</th>
                  <th width="4%">ขออนุมัติเข้า <br>(บ่าย)</th> -->
                  <th width="4%">เวลากลับ</th>
                  <!-- <th width="5%">ขออนุมัติออก <br>(บ่าย)</th>                  
                  <th width="2%">จำนวน <br>(ชั่วโมง)</th>
                  <th width="2%">จำนวน <br>(นาที)</th>
                  <th width="4%">ค่าล่วงเวลา <br>(บาท)</th>                   -->
              ...
              <div class='box-header with-border col-sm-offset-5'>
                <a href='otdata_work_generate.php?otdataid=<?php echo $otdata_id;?>' class='btn btn-info btn-sm btn-flat'><i class='fa fa-print'></i> พิมพ์บัญชีการมาทำงาน</a>              
              </div>
            </div>
          </div>
        </div>
