<?php
    ...
    function generateRow($id,$year_id,$otdata_month,$conn){
        ...
        if($_SESSION["deptid"]=='99'){
            $sql = "SELECT DISTINCT otdata_time_cal.*, employees.titlename, employees.firstname, employees.lastname, 
                    department.dept_name AS dept_name, otrate.otrate_name, otrate.is_holiday
        ...
        while($row = $query->fetch_assoc()){
            ...
            if($_SESSION["deptid"]=='99'){
                ...
                $sql2 = "SELECT DISTINCT otdata_time_cal.emp_id , SUM(otdata_time_cal.ot_amount) AS sumemp FROM otdata_time_cal 
                        LEFT JOIN approval_group ON approval_group.emp_id=otdata_time_cal.emp_id 
                        WHERE otdata_time_cal.otdata_id =".$id." AND otdata_time_cal.ot_amount > 0 AND otdata_time_cal.app_id IN 
                            ...
                            AND a.app_status = '1' 
                            ORDER BY a.app_month DESC, a.app_type_id) 
                        AND otdata_time_cal.emp_id ='".$row["emp_id"]."' 
                        AND approval_group.dept_id='".$_SESSION["deptid"]."' 
                        GROUP BY otdata_time_cal.emp_id 
                        ORDER BY otdata_time_cal.emp_id";
            ...
            if($empid_chk==""){
                $empid_chk=$row['emp_id'];
                $sumemp = @number_format($sumemp,2);
            }else{
                if($row['emp_id']!=$empid_chk){
                    $sumemp = @number_format($sumemp,2);
                }else{
                    $sumemp = "";
                }
            ...
            if($timein[0]>=16){
                ...
                if($row["is_holiday"]==1){
                    ...
                    $contents .= '
                        <tr>                
                            ...
                            <td width="5%" align="center">'.$row["num_hr"].'.'.$num_min.'</td>
                            <td width="5%" align="center"></td>
                            <td width="5%" align="center">'.number_format($row["ot_amount"],2).'</td>
                            <td width="7%" align="right">'.$sumemp.'</td>
                            <td width="7%">&nbsp;</td>		
                            <td width="7%">&nbsp;</td>		
                        </tr>
                        ';
                ...
                //     <td width="15%">'.$row["titlename"].$row["firstname"].' '.$row["lastname"].'</td>                
                //     <td width="8%" align="center">'.DateShortThai($row['ot_date']).'</td>
                //     <td width="7%" align="center">'.$strTypeDay.'</td>		
                //     <td width="6%" align="center">-</td>
                //     <td width="6%" align="center">-</td>
                //     <td width="6%" align="center">'.substr($row["ot2_in"],0,5).'</td>
                //     <td width="6%" align="center">'.substr($row["ot2_form_in"],0,5).'</td>
    ...
    //     <th width="15%" align="center" bgcolor="#c9c9c9"><b>ชื่อ – สกุล</b></th>        
    //     <th width="8%" align="center" bgcolor="#c9c9c9"><b>วันที่ปฏิบัติงาน</b></th>
    //     <th width="7%" align="center" bgcolor="#c9c9c9"><b>ประเภทวัน</b></th>
    //     <th width="6%" align="center" bgcolor="#c9c9c9"><b>สแกน<br>เข้า (เช้า)</br></th>
    //     <th width="6%" align="center" bgcolor="#c9c9c9"><b>อนุมัติ<br>เข้า (เช้า)</b></th>
    //     <th width="6%" align="center" bgcolor="#c9c9c9"><b>สแกน<br>เข้า (บ่าย)</b></th>
    //     <th width="6%" align="center" bgcolor="#c9c9c9"><b>อนุมัติ<br>เข้า (บ่าย)</b></th>
    ...
    //     <th width="6%" align="center" bgcolor="#c9c9c9"><b>จำนวน (นาที)</b></th>
    //     <th width="7%" align="center" bgcolor="#c9c9c9"><b>ค่าล่วงเวลา<br>(บาท)</b></th>
    //     <th width="7%" align="center" bgcolor="#c9c9c9"><b>วัน/เดือน/ปี<br>ที่รับเงิน</b></th>
    //     <th width="7%" align="center" bgcolor="#c9c9c9"><b>ลายมือชื่อ<br>ผู้รับเงิน</b></th>   
    // </tr>
    // </thead>
    // <tbody>      
    ...
    <thead>  
    <tr>         
        <th width="4%" rowspan="2" align="center" bgcolor="#c9c9c9"><b>ลำดับ</b></th>    
        <th width="15%" rowspan="2" align="center" bgcolor="#c9c9c9"><b>ชื่อ – สกุล</b></th>        
        <th width="8%" rowspan="2" align="center" bgcolor="#c9c9c9"><b>วันที่ปฏิบัติงาน</b></th>
        <th width="6%" rowspan="2" align="center" bgcolor="#c9c9c9"><b>สแกน<br>เข้า (เช้า)</br></th>
        <th width="6%" rowspan="2" align="center" bgcolor="#c9c9c9"><b>อนุมัติ<br>เข้า (เช้า)</b></th>
        <th width="6%" rowspan="2" align="center" bgcolor="#c9c9c9"><b>สแกน<br>เข้า (บ่าย)</b></th>
        <th width="6%" rowspan="2" align="center" bgcolor="#c9c9c9"><b>อนุมัติ<br>เข้า (บ่าย)</b></th>
        <th width="6%" rowspan="2" align="center" bgcolor="#c9c9c9"><b>สแกน<br>ออก</b> (บ่าย)</th>
        <th width="6%" rowspan="2" align="center" bgcolor="#c9c9c9"><b>อนุมัติ<br>ออก</b> (บ่าย)</th>
        <th colspan="2" width="10%" align="center" bgcolor="#c9c9c9"><b>รวมเวลาปฏิบัติงาน</b></th>
        <th colspan="2" width="10%" align="center" bgcolor="#c9c9c9"><b>จำนวนเงิน</b></th>
        <th width="7%" rowspan="2" align="center" bgcolor="#c9c9c9"><b>จำนวนเงิน<br>(รวม)</b></th>
        <th width="7%" rowspan="2" align="center" bgcolor="#c9c9c9"><b>วัน/เดือน/ปี<br>ที่รับเงิน</b></th>
        <th width="7%" rowspan="2" align="center" bgcolor="#c9c9c9"><b>ลายมือชื่อ<br>ผู้รับเงิน</b></th>   
    </tr>
    <tr>
        <th width="5%" align="center" bgcolor="#c9c9c9"><b>วันปกติ</b></th>
        <th width="5%" align="center" bgcolor="#c9c9c9"><b>วันหยุด</b></th>           
        <th width="5%" align="center" bgcolor="#c9c9c9"><b>วันปกติ</b></th>
        <th width="5%" align="center" bgcolor="#c9c9c9"><b>วันหยุด</b></th>        
    </tr>    
    </thead>
    ...
    // $footer = '<tr>                
    //         <td colspan="10" align="center"><b>รวม</b></td>            
    //         <td width="6%" align="center">'.$sumhour.'</td>
    //         <td width="6%" align="center">'.$summin.'</td>
    //         <td width="7%" align="right">'.number_format($sumamount,2).'</td>
    //         <td width="7%">&nbsp;</td>		
    ...
    // ';
    $footer = '<tr>                
            <td colspan="13" width="83%" align="center"><b>รวมเงินจ่ายทั้งสิ้น </b></td>            
            <td colspan="3" width="21%" align="right">'.number_format($sumamount,2).'</td>
        </tr>
    ';
