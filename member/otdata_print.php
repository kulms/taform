                      ...
                      if($_SESSION["deptid"]=='99'){
                        echo "
                          <tr>
                            ...
                            <td>
                              <button class='btn btn-warning btn-sm btn-flat' onclick='location.href=\"otdata_cal_print.php?otdataid=".$rowm['otdata_id']."\"' ><i class='fa fa-eye'></i> ดูบัญชีลงเวลาปฏิบัติงาน</button>                              
                            </td>
                          </tr>
                        ";                                               
                      }else{
