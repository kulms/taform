<?php
    ...
    $app_id = $_GET["appid"];
    $sql = "SELECT a.*, y.year_name, d.dept_name, d.dept_position, appt.app_type_name, appt.app_type_report, m.firstname, m.lastname  
            FROM approval a
    ...
    if(countRow($app_id,$conn)>12){
        ...
        <tr>  
            ...
            <td colspan="3">ประธานโครงการฯ</td>        
        </tr>
        ';    
        //$content .= generateRow($from, $to, $conn, $deduction);  
        $content .= '</table>';  

        $content .= '<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ด้วย'.$row["app_detail"].' มีความจำเป็นต้องให้พนักงานปฏิบัติงานนอกเวลาราชการ ในเดือน'.$app_month.' ดังรายนามต่อไปนี้ <br><br>';    
        ...
        <tr>  
            ...
            <img src="../images/number-three-md.png" height="12" width="12"><br>
                 อนุมัติ <br><br><br> (................................................) <br> ตำแหน่ง .................................... <br> วันที่....................................... 
            </td>
            <td></td>
            <td>
            <img src="../images/number-two-md.png" height="12" width="12"><br>
