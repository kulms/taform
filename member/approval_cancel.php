...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      แจ้งยกเลิกการยืนยันแบบฟอร์ม
      </h1>
      <ol class="breadcrumb">
        <li><a href="home.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="approval_form.php"> แบบฟอร์มขออนุมัติ</a></li>
        <li class="active">ยกเลิกการยืนยันแบบฟอร์ม</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-header with-border">
              ...
              <div class="box-header with-border col-sm-offset-5">
                <!-- <a href="javascript:iconfirmform('approval_confirm.php?confirm=1&appid=<?php echo $app_id;?>')" class="btn btn-info btn-sm btn-flat"><i class="fa fa-thumbs-up"></i> ยืนยันแบบฟอร์ม</a>                 -->
                <a  href="javascript:iunconfirmform('approval_undo.php?confirm=1&appid=<?php echo $app_id;?>')" class="btn btn-danger btn-sm btn-flat"><i class="fa fa-undo"></i> ยกเลิกการยืนยันแบบฟอร์ม</a>
              </div>
              <?php    
                }
              }
