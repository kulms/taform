        ...
        <div class="col-xs-12">
          <div class="box">            
            <div class="box-body">
              ...
              <form class="form-horizontal" method="POST" action="otdata.php">  
                <div class="box-body">                                        
                      ...
                      if($_SESSION["deptid"]=='99'){
                        echo "
                          <tr>
                            ...
                            <td>
                              <button class='btn btn-warning btn-sm btn-flat' onclick='location.href=\"otdata_view.php?otdataid=".$rowm['otdata_id']."\"' ><i class='fa fa-eye'></i> ดูข้อมูลจากเครื่องสแกน</button>
                              <button class='btn btn-danger btn-sm btn-flat delete' data-id='".$rowm['otdata_id']."'><i class='fa fa-trash'></i> ลบข้อมูล</button>
                            </td>
                          </tr>
                        ";                                               
                      }                                                 
