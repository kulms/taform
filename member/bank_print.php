...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      สร้าง Text File ส่งธนาคาร
      </h1>
      <ol class="breadcrumb">
        <li><a href="home.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">สร้าง Text File ส่งธนาคาร</li>
      </ol>
    </section>
    <!-- Main content -->
          ...
          <div class="box">            
            <div class="box-body">
              <div class="box-header with-border">
                <h3 class="box-title">ค้นหาบัญชีลงเวลาปฏิบัติงาน</h3>
              </div>
              <!-- /.box-header -->
              <!-- form start -->
              <!-- <form id="frmMain" class="form-horizontal" action="approval_form.php" method="post" enctype="multipart/form-data"> -->
              <form class="form-horizontal" method="POST" action="bank_print.php">  
                <div class="box-body">                                        
        ...
        if(isset($_POST['year_id'])){
          if($_POST['otdata_month']==""){
            ...
            if($_SESSION["deptid"]=='99'){
              ...
              $sqlCondition.=" AND a.year_id='".$year_id."' AND a.otdata_month = '".$otdata_month."' ";
            } 
          ...
          if($_SESSION["deptid"]=='99'){
            ...
            $sqlCondition.=" AND a.year_id='".$rowCurrYear["year_id"]."' AND a.otdata_month='".$curMonth."' ";
          }
        }
      ?>
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              <h4 class="box-title"> 
              แสดงผลข้อมูลบัญชีลงเวลาปฏิบัติงาน ปี พ.ศ.<?php echo $curYear;?> เดือน <?php echo MonthThai($curMonth);?>
              </h4>
              <table id="example3" class="table table-bordered" width="100%">
                ...
                <tbody>
                  <?php
                      ...
                      if($_SESSION["deptid"]=='99' || $_SESSION["deptid"]=='100'){
                        echo "
                          <tr>
                            ...
                            <td>
                              <button class='btn btn-warning btn-sm btn-flat' onclick='location.href=\"bank_cal_print.php?otdataid=".$rowm['otdata_id']."\"' ><i class='fa fa-eye'></i> แสดงข้อมูลค่าล่วงเวลา</button>                              
                            </td>
                          </tr>
                        ";                                               
                    //   }else{
                    ...
                    //         <td>".DateShortThai(date('Y-m-d',strtotime($rowm['create_date'])))."</td>                                                      
                    //         <td>
                    //           <button class='btn btn-warning btn-sm btn-flat' onclick='location.href=\"otdata_cal_print.php?otdataid=".$rowm['otdata_id']."\"' ><i class='fa fa-eye'></i> พิมพ์บัญชีลงเวลาปฏิบัติงาน</button>                              
                    //         </td>
                    //       </tr>
                    //     ";
                      }                                                 
