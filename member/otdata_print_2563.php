                      ...
                      if($_SESSION["deptid"]=='99'){
                        echo "
                          <tr>
                            ...
                            <td>
                              <button class='btn btn-warning btn-sm btn-flat' onclick='location.href=\"otdata_cal_print_2563.php?otdataid=".$rowm['otdata_id']."\"' ><i class='fa fa-eye'></i> พิมพ์บัญชีลงเวลาปฏิบัติงาน</button>                              
                            </td>
                          </tr>
                        ";                                               
                      }else{
