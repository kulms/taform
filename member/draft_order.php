        ...
        <div class="col-xs-12">
          <div class="box">            
            <div class="box-body">
              ...
              <form class="form-horizontal" method="POST" action="draft_order.php">  
                <div class="box-body">                                        
            ...
            <div class="box-body">
              ...
              <table id="order" class="table table-bordered" width="100%">
                <thead>
                  ...
                  <th width="8%">สถานะ</th> -->
                  <th width="15%">วันที่สร้างเอกสาร</th>                  
                  <!-- <th>Time Out</th> -->
                ...
                <?php
                    ...
                    //         FROM draft_order_form a                               
                    //             LEFT JOIN fiscal f ON f.fiscal_id=a.fiscal_id
                    //             LEFT JOIN ta_sem s ON s.sem_id=a.sem_id
                    //         ".$sqlCondition."
                    //           ORDER BY a.app_times ASC";
                    $sql = "SELECT DISTINCT a.fiscal_id, a.sem_id, a.app_times, a.create_date, f.fiscal_name, s.sem_name
                              FROM approval a                                   
                                  LEFT JOIN fiscal f ON f.fiscal_id=a.fiscal_id
                                  LEFT JOIN ta_sem s ON s.sem_id=a.sem_id
                            ".$sqlCondition."
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      echo "
                            <tr>
                              ...
                              <td>คำสั่งแต่งตั้งผู้ช่วยสอนประจำภาคต้น ปีการศึกษา ".$row["fiscal_name"]."</td>                          
                              <td>".DateShortThai($row["create_date"])."</td>                          
                              <td>                        
                              <button class='btn btn-warning btn-sm btn-flat' onclick='location.href=\"draft_order_generate.php?fid=".$row['fiscal_id']."&sid=".$row['sem_id']."&atimes=".$row['app_times']."\"' ><i class='fa fa-download'></i> ดาวน์โหลดร่างคำสั่ง</button>
                              </td>
                            </tr>
                            "; 
                      $i++;
