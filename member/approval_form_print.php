...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      พิมพ์แบบฟอร์มขออนุมัติ
      </h1>
      <ol class="breadcrumb">
        <li><a href="home.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">พิมพ์แบบฟอร์มขออนุมัติ</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col-xs-12">
          <div class="box">            
            <div class="box-body">
              ...
              <form class="form-horizontal" method="POST" action="approval_form_print.php">  
                <div class="box-body">                                        
            ...
            <div class="box-body">
              <table id="example3" class="table table-bordered" width="100%">
                <thead>
                  ...
                  <!-- <th>Name</th> -->
                  <th width="15%">แหล่งเงิน</th>
                  <th width="10%">สถานะ</th>
                  <th width="10%">วันที่สร้างเอกสาร</th>
                  <!-- <th>Time Out</th> -->
                ...
                <tbody>
                  <?php
                    ...
                    if($_SESSION["deptid"]=='99'){
                      $sql = "SELECT a.*, d.dept_name, y.year_name, at.app_type_name 
                              FROM approval a 
                                  ...
                                  ".$sqlCondition." AND a.app_status='1'
                      ...
                      $sql = "SELECT a.*, d.dept_name, y.year_name, at.app_type_name 
                              FROM approval a 
                                  ...
                                  LEFT JOIN years y ON y.year_id=a.year_id
                                  LEFT JOIN app_type at ON at.app_type_id=a.app_type_id
                              WHERE a.dept_id = '".$_SESSION["deptid"]."' AND a.app_status = 1
                              ".$sqlCondition." AND a.app_status='1'
                              ORDER BY a.app_month DESC, CONVERT(dept_name USING tis620), a.app_type_id";  
                    }
                    $query = $conn->query($sql);
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      //     <td>
                      //       <button class='btn btn-warning btn-sm btn-flat' onclick='location.href=\"approval.php?appid=".$row['app_id']."\"' ><i class='fa fa-users'></i> Edit Member</button>
                      //       <button class='btn btn-success btn-sm btn-flat edit' data-id='".$row['app_id']."'><i class='fa fa-edit'></i> Edit</button>
                      //       <button class='btn btn-danger btn-sm btn-flat delete' data-id='".$row['app_id']."'><i class='fa fa-trash'></i> Delete</button>
                      //     </td>
                      //   </tr>
                      // ";
                      if($row['app_status']==0){
                      ...
                      if($_SESSION["deptid"]=='99'){
                        echo "
                          <tr>
                            ...
                            <td>".$row['create_date']."</td>                          
                            <td>                              
                              <button class='btn btn-warning btn-sm btn-flat' onclick='location.href=\"approval_print.php?appid=".$row['app_id']."\"' ><i class='fa fa-print'></i> พิมพ์แบบฟอร์ม</button>
                            </td>
                          </tr>
                        ";
                      }else{
...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      ...
      $('#datepicker_approval_edit').val(response.app_date);
      ...
      $('#datepicker_approval_del').val(response.app_date);
