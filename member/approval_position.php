...
<div class="wrapper">
  ...
  <div class="content-wrapper">
                ...
                <tbody>
                  <?php
                    ...
                    if($_SESSION["deptid"]=='99'){
                      $sql = "SELECT *
                            FROM position                                                        
                            ORDER BY CONVERT(position.description USING tis620)";                          
                    }else{
                        $sql = "SELECT *
                            FROM position                                                        
                            ORDER BY CONVERT(position.description USING tis620)";
    ...
    <?php include 'includes/approval_position_modal.php'; ?>
...
function getRow(id){
  ...
  $.ajax({
    ...
    success: function(response){
      ...
      $('#id').val(response.id);
      $('#edit_position_name').val(response.description);      
    ...
    //   $('#edit_dept_bookno').val(response.dept_bookno);
      ...
      $('#del_position_name').val(response.description);      
