  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">พิมพ์บัญชีการมาทำงาน</li>
      </ol>
    </section>
    <!-- Main content -->
          ...
          <div class="box">            
            <div class="box-body">
              <div class="box-header with-border">
                <h3 class="box-title">ค้นหาบัญชีการมาทำงาน</h3>
              </div>
              <!-- /.box-header -->
              <!-- form start -->
              <!-- <form id="frmMain" class="form-horizontal" action="approval_form.php" method="post" enctype="multipart/form-data"> -->
              <form class="form-horizontal" method="POST" action="otdata_print.php">  
                <div class="box-body">                                        
      ...
      <?php
        ...
        if(isset($_POST['year_id'])){
          ...
          if($_SESSION["deptid"]=='99'){
            ...
            $sqlCondition.=" AND a.year_id='".$rowCurrYear["year_id"]."' ";
          }
        }
      ?>
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              <h4 class="box-title"> 
              แสดงผลข้อมูลบัญชีการมาทำงาน ปี พ.ศ.<?php echo $curYear;?> เดือน <?php echo MonthThai($curMonth);?>
              </h4>
                ...
                <tbody>
                  <?php
                    ...
                    if($_SESSION["deptid"]=='99'){                      
                      ...
                      //     ORDER BY a.otdata_month DESC";
                          $sqlm = "SELECT a.*, y.year_name 
                                   FROM otdata a, years y 
                                   WHERE y.year_id=a.year_id ".$sqlCondition."
                                   ORDER BY a.otdata_month DESC";
                    }
                      ...
                      if($_SESSION["deptid"]=='99'){
                        echo "
                          <tr>
                            ...
                            <td>
                              <button class='btn btn-warning btn-sm btn-flat' onclick='location.href=\"otdata_cal_work.php?otdataid=".$rowm['otdata_id']."\"' ><i class='fa fa-eye'></i> พิมพ์บัญชีการมาทำงาน</button>                              
                            </td>
                          </tr>
                        ";                                               
                      }else{
