  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">คำนวณเวลาทำงาน</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col-xs-12">
          <div class="box">            
            <div class="box-body">
              ...
              <form class="form-horizontal" method="POST" action="otdata_calculate.php">  
                <div class="box-body">                                        
                        ...
                        if($rowm['otdata_status']==0){
                          echo "
                            <tr>
                              ...
                              <td>
                                <button class='btn btn-success btn-sm btn-flat' onclick='location.href=\"otdata_cal.php?otdataid=".$rowm['otdata_id']."\"' ><i class='fa fa-gears'></i> คำนวณเวลาทำงาน</button>                              
                              </td>
                            </tr>
                          ";
                        }else{
                          echo "
                            <tr>
                              ...
                              <td>".DateShortThai(date('Y-m-d',strtotime($rowm['create_date'])))."</td>                                                      
                              <td>
                                <button class='btn btn-warning btn-sm btn-flat' onclick='location.href=\"otdata_cal_view.php?otdataid=".$rowm['otdata_id']."&cal=1\"' ><i class='fa fa-eye'></i> ดูผลการคำนวณ</button>                              
                              </td>
                            </tr>
                          ";
                        }                                               
