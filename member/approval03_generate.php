<?php
    ...
    $app_id = $_GET["appid"];
    $sql = "SELECT a.*, y.year_name, d.dept_name, appt.app_type_name, appt.app_type_report, m.firstname, m.lastname 
            FROM approval a
    ...
    if(countRow($app_id,$conn)>12){
        ...
        <tr>  
            <td width="45%">
                ...
                <tr>
                <td>
                 เรียน ประธานโครงการฯ ภาคพิเศษ <br>เห็นควรอนุมัติ <br><br> ลงนาม.................................... <br> ตำแหน่ง หัวหน้าสำนักงานเลขานุการ <br> วันที่....................................
                </td>
                </tr>
                </table>
            </td>
        ...
        <tr>  
            ...
            <img src="../images/number-four-md.png" height="12" width="12"><br>
                 อนุมัติ <br><br><br> (                      ) <br> ประธานโครงการฯ ภาคพิเศษ <br> วันที่....................................... 
            </td>
            <td></td>
            <td>
            <img src="../images/number-three-md.png" height="12" width="12"><br>
            กันเงินเลขที่ ....................................... <br>&nbsp; หมวด ค่าตอบแทนเงินรายได้โครงการฯ ภาคพิเศษ <br>&nbsp; หน่วยงาน  โครงการฯ ภาคพิเศษ <br> &nbsp;จำนวนเงิน ....................................... <br> จนท. การเงินคณะ  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  หัวหน้าสำนักงานเลขานุการ  <br>
            วันที่..........................&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;วันที่..........................
            </td>        
        </tr> 
        <table>       
        ...
        $content2 .= '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ในการนี้ขอเบิกค่าตอบแทนการปฏิบัติงานนอกเวลาราชการจากเงินงบประมาณหมวดค่าตอบแทนเงินรายได้<br>';    
        $content2 .= 'คณะวิศวกรรมศาสตร์ วงเงินไม่เกิน '.number_format($row["budget"],2).' บาท ('.num2wordsThai(substr($row["budget"],0,strlen($row["budget"])-3)).'บาทถ้วน)<br><br>';
        $content2 .= '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;จึงเรียนมาเพื่อโปรดพิจารณา หากเห็นชอบโปรดเสนอประธานโครงการฯ ภาคพิเศษอนุมัติหลักการต่อไป<br><br>';
